...
public class route_creation extends AppCompatActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickTimeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(route_creation.this,
        ...
        JsonObjectRequest ExampleStringRequest = new JsonObjectRequest(Request.Method.GET, routeCreated, null, new Response.Listener<JSONObject>(){
            ...
            public void onResponse(JSONObject response){
                ...
                try {
                    ...
                    Intent intent = new Intent(route_creation.this, routeDisplay.class);
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        case R.id.page_1:
                            ...
                            Intent intent1 = new Intent(route_creation.this, SavedRoutes.class);
                        ...
                        case R.id.page_2:
                            ...
                            Intent intent2 = new Intent(route_creation.this, MainActivity.class);
                        ...
                        case R.id.page_3:
                            ...
                            Intent intent3 = new Intent(route_creation.this, UserProfile.class);
                            ...
                            break;
                        case R.id.page_4:
                            Intent intent4 = new Intent(route_creation.this, PreviousRoutes.class);
