...
public class PreviousRouteDatabaseHelper extends SQLiteOpenHelper {
    public static final String dbName = "previous.db";
    public static final String tableName = "previous_table";
    ...
    public PreviousRouteDatabaseHelper(Context context){
